    ...
    func createProblem() {
        ...
        if levelCalc == 1 {
            ...
            if problemNumber == 2{
                ...
                label.text = "Scott, Frankie, and Corey played in the snow for 4 hours. Scott made 5 snowballs and 2 snowmen. Corey made 7 snowballs. Frankie made 4 snowballs and a snow fort. How many snowballs did the boys make?"}
            ...
            if problemNumber == 5{
                ...
                label.text =  "Albert has a large collection of books. He gave his best friend 14 books. He gave his little brother 8 books. Now Albert has 60 books in his collection. How many books did he have at first?"}
            if problemNumber == 6{
                
                answer = Int(24)
                
                label.text = "Kendra learns 12 new spelling words each week. Her goal is to learn 60 new words before her eighth birthday. She has already learned 36 new words. How many more words does Kendra need to learn?"}
            if problemNumber == 7{
                
                answer = Int(6)
                
                label.text = "Maddie, Luisa, and Amy counted their books. Maddie had 15 books. Luisa had 18 books. Together, Amy and Luisa had 9 more books than Maddie. How many books did Amy have?"}
            
            if problemNumber == 8{
                
                answer = Int(12)
                
                label.text = "At Pizza Palace, 1 large and 2 small pizzas cost the same as 5 small pizzas. A small pizza costs $4. What is the cost of a large pizza?" }
            if problemNumber == 9{
            ...
            if problemNumber == 10{
                ...
                label.text = "Chrissy had 20 marshmallows. Missy had 24 marshmallows. Chrissy ate 1/5 of her marshmallows. Missy ate 1/4 of her marshmallows. How many more marshmallows did Missy have left than Chrissy?"}
            if problemNumber == 11{
                
                answer = 2/3
                
                label.text = "Kevin spent 1/2 of his money on a video game. He spent 1/6 of his money on a pen. What fraction of his money did Kevin spend altogether?"}
            if problemNumber == 12{
                
                answer = 18
                
                label.text = "A pole is painted red, blue, and green. 1/3 of a pole is painted red. 1/2 of it is painted blue. Three feet of the pole is painted green. What is the height of the pole?"}
            if problemNumber == 13{
            ...
            if problemNumber == 14{
                ...
                answer = 399
                label.text = "The Money Hungry bank pays 5% interest annually. Selena put $380 in a savings account at the bank. At the end of one year, how much money will Selena have in her account?"}
            if problemNumber == 15{
